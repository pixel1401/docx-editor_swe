import { O as OoxmlNode } from "./ooxml-tree-CG0odFyi.js";
 ...
 */
declare function revisionsVisible(
 ...
 */
declare function paragraphMarkRevisionsOf(
  paragraph: OoxmlNode,
 ...
 */
declare function paragraphMarkFormatRevisionOf(
  paragraph: OoxmlNode,
 ...
 */
declare function shownMarkRevision(
  revisions: readonly RevisionAttribution[],
 ...
 */
declare function markRevisionRemovesMark(
 ...
 */
declare function paragraphMarkRevisionOf(
  paragraph: OoxmlNode,
): RevisionAttribution | null;
/**
 ...
 */
declare function formatRevisionOf(
  properties: readonly {
...
declare function revisionsAreDeletion(
  revisions: readonly RevisionAttribution[],
): boolean;

export {
  DEFAULT_REVISION_DISPLAY_MODE as D,
  type RevisionDisplayMode as R,
  type RevisionAttribution as a,
  type RevisionKind as b,
  paragraphMarkRevisionOf as c,
  paragraphMarkRevisionsOf as d,
  revisionsVisible as e,
  formatRevisionOf as f,
  markRevisionRemovesMark as m,
  paragraphMarkFormatRevisionOf as p,
  revisionsAreDeletion as r,
  shownMarkRevision as s,
};
