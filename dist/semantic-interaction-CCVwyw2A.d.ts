 ...
 * body sheet offsets.
 */
declare function caretStopsForBlocks(
  layout: SemanticLayout,
  pageIndex: number,
 ...
 */
declare function hitTestSemantic(
  layout: SemanticLayout,
  point: {
    readonly x: number;
    readonly y: number;
 ...
 */
declare function contentControlAtSemantic(
  layout: SemanticLayout,
  point: {
    readonly x: number;
    readonly y: number;
...
declare function contentControlsInLayout(
  layout: SemanticLayout,
 ...
 */
declare function paragraphTextFromLayout(
  layout: SemanticLayout,
  paragraphId: string,
): string;
 ...
 * cached as geometry.
 */
declare function compositionAnchor(
  layout: SemanticLayout,
  position: SemanticPosition,
): CaretGeometry | null;
/** The style spans a selection touches, for reporting active formatting. */
declare function spansInSelection(
  layout: SemanticLayout,
  selection: SemanticSelection,
): StyleSpanRecord[];

export {
  type CaretGeometry as C,
  type MoveCaretOptions as M,
  type NavigationCommand as N,
  type SemanticPosition as S,
  type SemanticSelection as a,
  type SelectionRect as b,
  type CaretAtOptions as c,
  caretAt as d,
  caretStops as e,
  caretStopsForBlocks as f,
  compositionAnchor as g,
  contentControlAtSemantic as h,
  contentControlsInLayout as i,
  hitTestSemantic as j,
  moveCaret as m,
  paragraphTextFromLayout as p,
  spansInSelection as s,
};
