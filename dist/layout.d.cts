import { V as VersionedShapingLibrary, T as TextShaper, F as FontByteValidator, a as FixedPointRoundingMode, b as FixedPoint, c as TextDirection, S as ShapedRun } from './shaped-measurer-Dx4llNhK.cjs';
export { C as CacheLookup, d as CacheMiss, e as CacheProvenance, D as DeclaredFontSubstitution, f as FontFingerprintInputs, g as FontRequest, h as FontResolutionError, i as FontResolutionErrorCode, j as FontResourceDefinition, k as FontResourceInstrumentation, l as FontResourceSnapshot, m as FontResourceSnapshotOptions, n as FontSubstitution, o as FontValidationResult, G as GlyphOutline, H as HARD_MAX_AGGREGATE_FONT_BYTES, p as HARD_MAX_FONT_BYTES, q as HARD_MAX_FONT_SOURCES, L as LayoutShapingOptions, N as NormalizationPolicy, O as OperationSnapshot, r as OperationSnapshotField, s as OperationSnapshotGuard, R as ResolvedCache, t as ResolvedFont, u as ResourceDependencyProvenance, v as ShapeInput, w as ShapedCluster, x as ShapedFontSpan, y as ShapedGlyph, z as ShapedMeasurerOptions, A as ShapedRunComparatorInputs, B as ShapedVerticalMetrics, E as ShapingEnvironment, I as ShapingEnvironmentFingerprintInputs, J as ShapingEnvironmentInput, K as boundedStructuralFontValidator, M as captureOperationSnapshot, P as createFontResourceSnapshot, Q as createShapedMeasurer, U as createShapedRun, W as createShapingEnvironment, X as fixedPoint, Y as fontRequestKey, Z as guardOperationSnapshot, _ as sha256FontBytes, $ as shapedRunComparatorInputs, a0 as shapingEnvironmentFingerprint, a1 as shapingEnvironmentFingerprintInputs } from './shaped-measurer-Dx4llNhK.cjs';
import { d as LayoutBox, D as DrawingPoint, e as DrawingInsets, a as StyleSpanRecord, I as InlineDrawingRecord, M as ModelRange, R as ResolvedRunStyle, f as ThemeFonts, g as ParagraphSpacing, h as ParagraphLineSpacing, i as ParagraphBorderEdge, j as ParagraphBorders, k as ResolvedTabStops, l as TableBorderSide, S as SemanticLayout, B as BlockFragmentRecord, m as InlineDrawingLayoutContext, T as TextMeasurer, H as HyperlinkProjector, F as FieldLinkProjector, n as PageRecord, o as ParagraphFragmentRecord, p as StoryPageFieldNeeds, A as AnchoredDrawingRecord, P as PageGeometry, q as CellBorderBox, r as TableBorderBox } from './semantic-records-Dq8SlCY8.cjs';
export { s as AUTO_PARAGRAPH_SPACING_PT, t as BorderGridGeometry, C as ContentControlBoundaryRecord, u as ContentControlGeometryFragment, v as ContentControlLevel, w as ContentControlLock, x as ContentControlMappedType, y as DEFAULT_PAGE_GEOMETRY, z as DEFAULT_RUN_STYLE, E as DEFAULT_TAB_INTERVAL_PT, G as DEFAULT_TAB_INTERVAL_TWIPS, J as EMPTY_TAB_STOPS, K as FieldAtomMarker, N as HeaderFooterStoryRecord, O as HyperlinkFieldSpec, L as LineRecord, Q as LineSpacingRule, U as ListMarkerRecord, V as MAX_BORDER_SPACE_PT, W as MAX_BORDER_WIDTH_PT, X as MAX_PARAGRAPH_SPACING_PT, Y as MAX_TABLE_BORDER_STROKES, Z as MAX_TAB_POSITION_TWIPS, _ as MAX_TAB_STOPS, $ as PARAGRAPH_BORDER_SIDES, a0 as ParagraphAutoSpacingContext, a1 as ParagraphBorderSide, a2 as ParagraphBorderStrokeRecord, a3 as ParagraphBottomBorderRecord, a4 as ParagraphIndent, a5 as ResolvedCellBorders, a6 as ResolvedTableBorderEdge, a7 as ResolvedTableBorderEdgeSegment, a8 as ResolvedUnderline, a9 as SINGLE_LINE_SPACING, aa as SourceRange, ab as SpanLinkRecord, ac as TAB_LEADER_GLYPH, ad as TabAlignment, ae as TabDestination, af as TabLeader, ag as TabStop, ah as TableBorderSideName, ai as TableBorderStrokeRecord, c as TableCellFragmentRecord, aj as TableFragmentRecord, b as TableRowFragmentRecord, ak as VerticalAlign, al as appliedSpaceBefore, am as applyLineSpacing, an as baselineShiftPtOf, ao as borderExtentPt, ap as borderWeight, aq as bottomBorderExtentPt, ar as cascadedParagraphBorders, as as cascadedTabStops, at as collapsedSpaceBefore, au as contentControlsOfLayout, av as defaultTabIntervalFromSettings, aw as displayText, ax as effectiveContentControlLock, ay as fragmentsOfParagraph, az as lineAtPosition, aA as linesOf, aB as measureDisplayText, aC as nextTabDestination, aD as paragraphBorderExtentPt, aE as paragraphBorderStrokeWidthPt, aF as paragraphBorders, aG as paragraphBordersFingerprint, aH as paragraphBreaksBefore, aI as paragraphContextualSpacing, aJ as paragraphFragmentsOf, aK as paragraphFragmentsOfBlocks, aL as paragraphLineSpacing, aM as paragraphSpacing, aN as paragraphTabStops, aO as readBorderSide, aP as readCellBorders, aQ as readTableBorders, aR as resolveBorderConflict, aS as resolveRunStyle, aT as resolveTableCellBorderGrid, aU as runStylesEqual, aV as tabAdvanceWidth, aW as tabStopsFingerprint, aX as unionLayoutBoxes, aY as withDefaultTabInterval } from './semantic-records-Dq8SlCY8.cjs';
import { O as OoxmlNode, a as OoxmlElement, e as OoxmlPart } from './ooxml-tree-CG0odFyi.cjs';
import { O as OoxmlProperty, C as ContentControlKind, n as ContentControlLevel, o as ContentControlLock, p as ContentControlDataBinding, I as ImpactClass } from './tree-op-types-DOYNkKqD.cjs';
export { m as TableBorderStyle } from './tree-op-types-DOYNkKqD.cjs';
import { N as NoteKind, n as noteTypeOf } from './note-nodes-B2wWES2L.cjs';
import { R as ResolvedFootnoteProperties, a as ResolvedEndnoteProperties } from './note-properties-Dhqkro--.cjs';
export { p as paragraphOrderOfPart } from './note-properties-Dhqkro--.cjs';
import { D as DocumentProperties, T as TreeModelChange } from './tree-store-Jg-q7fyf.cjs';
import { R as RevisionDisplayMode } from './revision-projection-DRZMzoLD.cjs';
export { D as DEFAULT_REVISION_DISPLAY_MODE, a as RevisionAttribution, b as RevisionKind, f as formatRevisionOf, m as markRevisionRemovesMark, p as paragraphMarkFormatRevisionOf, c as paragraphMarkRevisionOf, d as paragraphMarkRevisionsOf, r as revisionsAreDeletion, e as revisionsVisible, s as shownMarkRevision } from './revision-projection-DRZMzoLD.cjs';
import { a as SectionColumns } from './semantic-cell-selection-CdNQ-a9-.cjs';
export { C as CellSelection, D as DEFAULT_SECTION_PROPERTIES, b as DEFAULT_VERTICAL_WEIGHT, c as DocumentSection, d as DocumentSectionsEnumeration, e as DrawingOverlayFrame, H as HitPoint, f as HitTestOptions, M as MAX_DOCUMENT_SECTIONS, P as PlacedCell, g as SectionBreakType, h as SectionColumnDefinition, i as SectionMargins, j as SectionPageNumbering, S as SectionProperties, k as SemanticHit, l as SemanticHitDrawing, T as TableCellAddress, m as TableCellContext, n as caretBoxOnLine, o as cellSelectionBetween, p as cellSelectionRects, q as cellSelectionText, r as contentControlAtPoint, s as enumerateDocumentSections, t as enumerateDocumentSectionsBounded, u as findDrawingOverlayFrameInLayout, v as geometryOfSection, w as hitTestPage, x as hitTestSheet, y as isFurniturePoint, z as lineEndOffset, A as pageAtY, B as paragraphSectionNode, E as paragraphsInCells, F as parsePageNumbering, G as parseSectionProperties, I as readSectionProperties, J as spanOffsetX, K as spansInCells, L as tableContextAt } from './semantic-cell-selection-CdNQ-a9-.cjs';
export { M as MAX_SDT_NESTING, c as collectFlowBlocks, a as contentControlContentChildren, i as isContentControl, b as isContentControlContent } from './content-control-walk-BeAFh6Xi.cjs';
export { h as CommentAnchor, i as CommentPosition, C as CommentRecord, j as CommentThreadState, c as ReviewCommentItem, d as ReviewCustomItem, a as ReviewItem, R as ReviewModelInput, k as ReviewParagraphAnchor, e as ReviewPosition, f as ReviewRange, b as ReviewRevisionItem, g as ReviewRevisionKind, W as W15_NAMESPACE_URI, l as activeReviewItem, m as anchorLineY, n as commentBodyText, o as commentInitials, p as firstReviewRange, r as reviewAnchorIndex, q as reviewItemGeometry, s as reviewItemKey, t as reviewItemPositionRank, u as reviewItemRanges, v as reviewItemsAt, w as reviewThreadRootOf } from './review-support-CHuJxHmz.cjs';
import { S as SemanticPosition, b as SelectionRect, a as SemanticSelection } from './semantic-interaction-DgaWs-5w.cjs';
export { c as CaretAtOptions, C as CaretGeometry, M as MoveCaretOptions, N as NavigationCommand, d as caretAt, e as caretStops, f as caretStopsForBlocks, g as compositionAnchor, h as contentControlAtSemantic, i as contentControlsInLayout, j as hitTestSemantic, m as moveCaret, p as paragraphTextFromLayout, s as spansInSelection } from './semantic-interaction-DgaWs-5w.cjs';
