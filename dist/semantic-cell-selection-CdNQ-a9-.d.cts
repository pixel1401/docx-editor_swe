import { e as OoxmlPart, a as OoxmlElement, O as OoxmlNode } from './ooxml-tree-CG0odFyi.cjs';
import { P as PageGeometry, I as InlineDrawingRecord, A as AnchoredDrawingRecord, T as TextMeasurer, L as LineRecord, a as StyleSpanRecord, S as SemanticLayout, C as ContentControlBoundaryRecord, b as TableRowFragmentRecord, c as TableCellFragmentRecord } from './semantic-records-Dq8SlCY8.cjs';
import { R as RevisionDisplayMode } from './revision-projection-DRZMzoLD.cjs';
import { S as SemanticPosition, C as CaretGeometry, a as SemanticSelection } from './semantic-interaction-DgaWs-5w.cjs';
