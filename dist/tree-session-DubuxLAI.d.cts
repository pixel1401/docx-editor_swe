...
import { S as StoryScope, a as StoryTargetRejection, D as DocumentTrackingSettings, I as InsertCustomNodeWrite, C as CustomNodeWriteResult, b as CustomNodeSweepOutcome, E as EmbeddedFont, B as BookmarkIndex, L as ListKind, c as InsertImageInput, d as ImageIntentResult, R as ReplaceImageOptions, A as ApplyImagePropertiesInput } from './custom-node-writes-CIC_-wad.cjs';
import { Node } from 'prosemirror-model';
import { a as ReviewItem } from './review-support-CHuJxHmz.cjs';
import { ReviewModuleContribution } from './contracts/modules.cjs';
import { e as OoxmlPart, O as OoxmlNode, a as OoxmlElement } from './ooxml-tree-CG0odFyi.cjs';
import { O as OoxmlPackage, b as OoxmlPackageRejection } from './ooxml-package-Cmbe_M04.cjs';
import { a as HeaderFooterParts, b as HeaderFooterSectionResolution } from './hf-references-BPET4tlK.cjs';
import { S as SelectionMark, T as TreeModelChange, D as DocumentProperties } from './tree-store-Jg-q7fyf.cjs';
import { T as TreeDocOp } from './tree-op-types-DOYNkKqD.cjs';
