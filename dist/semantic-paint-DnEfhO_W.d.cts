import { C as ContentControlBoundaryRecord, S as SemanticLayout } from './semantic-records-Dq8SlCY8.cjs';
import { V as ValidatedImageBytesHandle, R as RenderableImageMime } from './image-resources-CSlQmPIm.cjs';
...
export { DEFAULT_FIELD_SHADING as D, type FieldShadingMode as F, type PaintOptions as P, type ReviewAuthorInfo as R, type RevisionAuthorAssignments as a, type RevisionAuthorStyle as b, type RevisionStyles as c, type DrawingPaintStrings as d, paintSemanticLayout as p };
