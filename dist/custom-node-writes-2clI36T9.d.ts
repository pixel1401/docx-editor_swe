import { e as OoxmlPart, O as OoxmlNode } from "./ooxml-tree-CG0odFyi.js";
...
import { N as NoteKind } from "./note-nodes-CZQXU6Fg.js";
import {
  T as TreeModelChange,
  a as TreeStoryRef,
  b as TreeDocumentStore,
  c as TransactionContext,
  d as TransactOptions,
  S as SelectionMark,
  e as TreeDocumentCheckpoint,
 ...
 */
declare function allocateDrawingPropertyId(
  pkg: OoxmlPackage,
 ...
 */
declare function withBinaryPart(
  pkg: OoxmlPackage,
  partName: string,
  bytes: Uint8Array,
  contentType: string,
 ...
 */
declare function withEmbeddedImage(
  pkg: OoxmlPackage,
...
declare function withoutUnreferencedImagePart(
  pkg: OoxmlPackage,
  partName: string,
): OoxmlPackage;
 ...
 */
declare function deobfuscateFont(
  bytes: Uint8Array,
  fontKey: string,
): Uint8Array | null;
 ...
 */
declare function readEmbeddedFonts(
  pkg: OoxmlPackage,
 ...
 */
declare function ensureListDefinition(
  pkg: OoxmlPackage,
  kind: ListKind,
 ...
 * link resolves.
 */
declare function ensureNumberingLevel(
  pkg: OoxmlPackage,
  numId: string,
  level: number,
  kind: ListKind,
 ...
 */
declare function applyHeaderFooterLifecycleOp(
  pkg: OoxmlPackage,
...
type NoteDiagnosticCode =
  "dangling-note-reference" | "note-reference-scan-truncated";
/**
...
declare function createNoteReferenceScanBudget(
  maxVisited?: number,
  maxParts?: number,
 ...
 */
declare function resolveNotesPart(
  pkg: OoxmlPackage,
  noteKind: NoteKind,
): OoxmlPart | null;
/**
 ...
 */
declare function collectNoteReferences(
  part: OoxmlPart,
  options?: {
...
declare function collectPackageNoteReferences(
  pkg: OoxmlPackage,
  options?: {
    readonly budget?: NoteReferenceScanBudget;
 ...
 */
declare function diagnoseNoteReferences(
  pkg: OoxmlPackage,
): readonly NoteDiagnostic[];
 ...
 */
declare function applyNoteLifecycleOp(
  pkg: OoxmlPackage,
  op: NoteLifecycleOp,
 ...
 */
declare function cascadeDeletedNoteReferences(
  before: OoxmlPackage,
  after: OoxmlPackage,
...
declare function readTrackingSettings(
...
declare class TreePackageStore {
  ...
  constructor(
    pkg: OoxmlPackage,
    main: OoxmlPart,
    options?: TreePackageStoreOptions,
  );
 ...
 */
declare function insertCustomNodeWrite(
  store: TreeDocumentStore,
 ...
 */
declare function removeCustomNodeWrite(
  store: TreeDocumentStore,
 ...
 */
declare function sweepCustomNodePayloads(
  pkg: OoxmlPackage,
...
export {
  customNodePayloadsByControl as $,
  type ApplyImagePropertiesInput as A,
  type BookmarkIndex as B,
  type CustomNodeWriteResult as C,
  type DocumentTrackingSettings as D,
  type EmbeddedFont as E,
  type FontStyleKey as F,
  type NoteReferenceScanBudget as G,
  type HeaderFooterLifecycleImpact as H,
  type InsertCustomNodeWrite as I,
  type ReadEmbeddedFontsOptions as J,
  type StoryResolveResult as K,
  type ListKind as L,
  MAX_CUSTOM_NODE_LABEL_LENGTH as M,
  NO_TRACKING_SETTINGS as N,
  type TreePackageStoreOptions as O,
  type PackageTransactResult as P,
  allocateDrawingPropertyId as Q,
  type ReplaceImageOptions as R,
  type StoryScope as S,
  TreePackageStore as T,
  applyHeaderFooterLifecycleOp as U,
  applyNoteLifecycleOp as V,
  buildBookmarkIndex as W,
  cascadeDeletedNoteReferences as X,
  collectNoteReferences as Y,
  collectPackageNoteReferences as Z,
  createNoteReferenceScanBudget as _,
  type StoryTargetRejection as a,
  customNodePayloadsOf as a0,
  deobfuscateFont as a1,
  diagnoseNoteReferences as a2,
  ensureListDefinition as a3,
  ensureNumberingLevel as a4,
  insertCustomNodeWrite as a5,
  isHeaderFooterLifecycleOp as a6,
  isNoteLifecycleOp as a7,
  normalNoteIds as a8,
  notesPartHasId as a9,
  readEmbeddedFonts as aa,
  readTrackingSettings as ab,
  removeCustomNodeWrite as ac,
  resolveNotesPart as ad,
  sweepCustomNodePayloads as ae,
  withBinaryPart as af,
  withEmbeddedImage as ag,
  withoutUnreferencedImagePart as ah,
  type CustomNodeSweepOutcome as b,
  type InsertImageInput as c,
  type ImageIntentResult as d,
  type BookmarkAnchor as e,
  type CascadeDeletedNoteReferencesOptions as f,
  type CustomNodePayloadRead as g,
  type CustomNodePayloadWrite as h,
  type CustomNodeSweepResult as i,
  type CustomNodeWriteRejection as j,
  DEFAULT_MAX_EDITABLE_STORY_PARTS as k,
  type DrawingPropertyIdResult as l,
  type HeaderFooterLifecycleOp as m,
  type HeaderFooterLifecycleRejection as n,
  type HeaderFooterLifecycleResult as o,
  MAX_CUSTOM_NODE_PAYLOAD_LENGTH as p,
  MAX_NOTE_REFERENCE_PARTS as q,
  MAX_NOTE_REFERENCE_SCAN as r,
  type NoteDiagnostic as s,
  type NoteDiagnosticCode as t,
  type NoteLifecycleImpact as u,
  type NoteLifecycleOp as v,
  type NoteLifecycleOptions as w,
  type NoteLifecycleRejection as x,
  type NoteLifecycleResult as y,
  type NoteReferenceHit as z,
};
