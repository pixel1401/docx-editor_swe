 ...
 */
type ZipRejection =
  "too-many-entries" | "too-large" | "bad-name" | "inflate-error";
 ...
 */
declare function resolveInternalTarget(
...
declare const IMAGE_RELATIONSHIP_TYPE =
...
declare function buildRelationshipSet(
 ...
 */
declare function resolveRelationship(
 ...
 */
declare function resolveImageRelationship(
 ...
 */
declare function buildContentTypeIndex(
...
declare function resolveContentType(
...
declare const DEFAULT_OOXML_PACKAGE_LIMITS: Required<
 ...
 */
declare function readOoxmlPackage(
  bytes: Uint8Array,
...
export {
  readOoxmlPackage as A,
  readZip as B,
  type ContentTypeError as C,
  DEFAULT_OOXML_PACKAGE_LIMITS as D,
  resolveContentType as E,
  resolveImageRelationship as F,
  resolveInternalTarget as G,
  resolveRelationship as H,
  IMAGE_RELATIONSHIP_TYPE as I,
  validateExternalTarget as J,
  withPart as K,
  writeOoxmlPackage as L,
  writeZip as M,
  type NameRejection as N,
  type OoxmlPackage as O,
  type RelationshipRecord as R,
  type TargetMode as T,
  type ZipLimits as Z,
  type OoxmlPackageLimits as a,
  type OoxmlPackageRejection as b,
  type ContentTypeIndex as c,
  type ContentTypeRecords as d,
  DEFAULT_ZIP_LIMITS as e,
  type DefaultRecord as f,
  type ImageRelationshipResolution as g,
  type IndexResult as h,
  type NameResult as i,
  type OoxmlExternalTarget as j,
  type OoxmlPackageResult as k,
  type OverrideRecord as l,
  type RelationshipError as m,
  type RelationshipSetResult as n,
  type ResolveResult as o,
  type ResolvedRelationship as p,
  type ZipReadResult as q,
  type ZipRejection as r,
  asciiFold as s,
  buildContentTypeIndex as t,
  buildRelationshipSet as u,
  detectDuplicateNames as v,
  extensionKey as w,
  isValidMime as x,
  normalizePartName as y,
  partNameKey as z,
};
