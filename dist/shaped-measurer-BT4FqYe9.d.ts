...
type FontResolutionErrorCode =
  "missing" | "forbidden" | "overLimit" | "malformed" | "hashMismatch";
/**
 ...
 */
declare const createFontResourceSnapshot: (
 ...
 */
declare const createShapingEnvironment: (
 ...
 */
declare const shapedRunComparatorInputs: (
  input: ShapedRun,
  environment: ShapingEnvironmentInput,
 ...
 */
declare function createShapedMeasurer(
  options: ShapedMeasurerOptions,
): TextMeasurer;

export {
  shapedRunComparatorInputs as $,
  type ShapedRunComparatorInputs as A,
  type ShapedVerticalMetrics as B,
  type CacheLookup as C,
  type DeclaredFontSubstitution as D,
  type ShapingEnvironment as E,
  type FontByteValidator as F,
  type GlyphOutline as G,
  HARD_MAX_AGGREGATE_FONT_BYTES as H,
  type ShapingEnvironmentFingerprintInputs as I,
  type ShapingEnvironmentInput as J,
  boundedStructuralFontValidator as K,
  type LayoutShapingOptions as L,
  captureOperationSnapshot as M,
  type NormalizationPolicy as N,
  type OperationSnapshot as O,
  createFontResourceSnapshot as P,
  createShapedMeasurer as Q,
  ResolvedCache as R,
  type ShapedRun as S,
  type TextShaper as T,
  createShapedRun as U,
  type VersionedShapingLibrary as V,
  createShapingEnvironment as W,
  fixedPoint as X,
  fontRequestKey as Y,
  guardOperationSnapshot as Z,
  sha256FontBytes as _,
  type FixedPointRoundingMode as a,
  shapingEnvironmentFingerprint as a0,
  shapingEnvironmentFingerprintInputs as a1,
  type FixedPoint as b,
  type TextDirection as c,
  type CacheMiss as d,
  type CacheProvenance as e,
  type FontFingerprintInputs as f,
  type FontRequest as g,
  FontResolutionError as h,
  type FontResolutionErrorCode as i,
  type FontResourceDefinition as j,
  type FontResourceInstrumentation as k,
  type FontResourceSnapshot as l,
  type FontResourceSnapshotOptions as m,
  type FontSubstitution as n,
  type FontValidationResult as o,
  HARD_MAX_FONT_BYTES as p,
  HARD_MAX_FONT_SOURCES as q,
  type OperationSnapshotField as r,
  type OperationSnapshotGuard as s,
  type ResolvedFont as t,
  type ResourceDependencyProvenance as u,
  type ShapeInput as v,
  type ShapedCluster as w,
  type ShapedFontSpan as x,
  type ShapedGlyph as y,
  type ShapedMeasurerOptions as z,
};
