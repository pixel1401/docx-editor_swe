...
declare function childElements(
  node: Extract<
    XmlNode,
    {
      type: "element";
...
declare const WML_NAMESPACE_URI =
...
declare const W14_NAMESPACE_URI =
  "http://schemas.microsoft.com/office/word/2010/wordml";
declare const DRAWINGML_MAIN_NAMESPACE_URI =
  "http://schemas.openxmlformats.org/drawingml/2006/main";
declare const WP_NAMESPACE_URI =
  "http://schemas.openxmlformats.org/drawingml/2006/wordprocessingDrawing";
declare const PIC_NAMESPACE_URI =
  "http://schemas.openxmlformats.org/drawingml/2006/picture";
/** The four content-position revision wrappers, which nest and carry runs. */
declare function isContentRevisionKind(
  kind: OoxmlNode["kind"],
): kind is
  "revisionInsert" | "revisionDelete" | "revisionMoveFrom" | "revisionMoveTo";
/** Move-range and comment-range boundary markers, which are empty and sit between runs. */
declare function isRangeMarkerKind(
  kind: OoxmlNode["kind"],
): kind is
  | "moveFromRangeStart"
  | "moveFromRangeEnd"
 ...
 */
declare function readOnOffChild(
  parent: OoxmlNode,
  localName: string,
  namespaceUri?: string,
): boolean;
...
type OoxmlKnownNodeAttribute =
  OoxmlXmlSpaceAttribute | OoxmlGenericExtensionAttribute;
...
interface OoxmlDocumentNode extends OoxmlElementBase<
...
interface OoxmlBodyNode extends OoxmlElementBase<
  readonly (
    | OoxmlParagraphNode
    | OoxmlTableNode
...
interface OoxmlTableNode extends OoxmlElementBase<
  readonly (
...
interface OoxmlTableRowNode extends OoxmlElementBase<
  readonly (
    OoxmlTableCellNode | OoxmlContentControlNode | OoxmlGenericElementNode
  )[],
  readonly OoxmlKnownNodeAttribute[]
> {
...
interface OoxmlTableCellNode extends OoxmlElementBase<
  readonly (
    | OoxmlParagraphNode
    | OoxmlTableNode
    | OoxmlContentControlNode
...
interface OoxmlTableGridNode extends OoxmlElementBase<
...
interface OoxmlTablePropertiesNode extends OoxmlElementBase<
  readonly OoxmlGenericElementNode[],
  readonly OoxmlKnownNodeAttribute[]
> {
 ...
 */
interface OoxmlParagraphNode extends OoxmlElementBase<
  readonly (
 ...
 */
interface OoxmlHyperlinkNode extends OoxmlElementBase<
  readonly (
    | OoxmlRunNode
    | OoxmlHyperlinkNode
    | OoxmlContentControlNode
 ...
 */
interface OoxmlRevisionContentNode extends OoxmlElementBase<
  readonly (
    | OoxmlRunNode
    | OoxmlRevisionContentNode
    | OoxmlHyperlinkNode
 ...
 */
interface OoxmlBookmarkStartNode extends OoxmlElementBase<
  readonly [],
  readonly OoxmlKnownNodeAttribute[]
> {
...
interface OoxmlBookmarkEndNode extends OoxmlElementBase<
  readonly [],
  readonly OoxmlKnownNodeAttribute[]
> {
 ...
 * for the other.
 */
interface OoxmlRangeMarkerNode extends OoxmlElementBase<
  readonly [],
  readonly OoxmlKnownNodeAttribute[]
> {
  readonly kind:
...
interface OoxmlCommentReferenceNode extends OoxmlElementBase<
  readonly [],
  readonly OoxmlKnownNodeAttribute[]
> {
...
interface OoxmlCommentsNode extends OoxmlElementBase<
 ...
 */
interface OoxmlCommentNode extends OoxmlElementBase<
...
interface OoxmlRunNode extends OoxmlElementBase<
  readonly (
...
interface OoxmlDrawingNode extends OoxmlElementBase<
  readonly (
    OoxmlInlineDrawingNode | OoxmlAnchoredDrawingNode | OoxmlGenericElementNode
  )[],
  readonly OoxmlKnownNodeAttribute[]
> {
...
interface OoxmlInlineDrawingNode extends OoxmlElementBase<
...
interface OoxmlAnchoredDrawingNode extends OoxmlElementBase<
  readonly OoxmlDrawingAnchorChild[],
  readonly OoxmlKnownNodeAttribute[]
> {
...
interface OoxmlDrawingExtentNode extends OoxmlElementBase<
  readonly [],
  readonly OoxmlKnownNodeAttribute[]
> {
...
interface OoxmlDrawingEffectExtentNode extends OoxmlElementBase<
  readonly [],
  readonly OoxmlKnownNodeAttribute[]
> {
...
interface OoxmlDrawingDocPrNode extends OoxmlElementBase<
  readonly OoxmlGenericElementNode[],
  readonly OoxmlKnownNodeAttribute[]
> {
...
interface OoxmlDrawingGraphicFramePrNode extends OoxmlElementBase<
  readonly OoxmlGenericElementNode[],
  readonly OoxmlKnownNodeAttribute[]
> {
...
interface OoxmlDrawingGraphicNode extends OoxmlElementBase<
...
interface OoxmlDrawingGraphicDataNode extends OoxmlElementBase<
...
interface OoxmlDrawingSimplePosNode extends OoxmlElementBase<
  readonly [],
  readonly OoxmlKnownNodeAttribute[]
> {
...
interface OoxmlDrawingPositionHNode extends OoxmlElementBase<
  readonly (
...
interface OoxmlDrawingPositionVNode extends OoxmlElementBase<
  readonly (
    | OoxmlDrawingPositionAlignNode
    | OoxmlDrawingPositionOffsetNode
    | OoxmlGenericElementNode
...
interface OoxmlDrawingPositionAlignNode extends OoxmlElementBase<
...
interface OoxmlDrawingPositionOffsetNode extends OoxmlElementBase<
  readonly (OoxmlTextNode | OoxmlGenericElementNode)[],
  readonly OoxmlKnownNodeAttribute[]
> {
...
interface OoxmlDrawingWrapNoneNode extends OoxmlElementBase<
  readonly OoxmlGenericElementNode[],
  readonly OoxmlKnownNodeAttribute[]
> {
...
interface OoxmlDrawingWrapSquareNode extends OoxmlElementBase<
...
interface OoxmlDrawingWrapTightNode extends OoxmlElementBase<
...
interface OoxmlDrawingWrapThroughNode extends OoxmlElementBase<
  readonly (OoxmlDrawingWrapPolygonNode | OoxmlGenericElementNode)[],
  readonly OoxmlKnownNodeAttribute[]
> {
...
interface OoxmlDrawingWrapTopBottomNode extends OoxmlElementBase<
  readonly (OoxmlDrawingEffectExtentNode | OoxmlGenericElementNode)[],
  readonly OoxmlKnownNodeAttribute[]
> {
...
interface OoxmlDrawingWrapPolygonNode extends OoxmlElementBase<
  readonly (
...
interface OoxmlDrawingWrapPolygonStartNode extends OoxmlElementBase<
  readonly [],
  readonly OoxmlKnownNodeAttribute[]
> {
...
interface OoxmlDrawingWrapPolygonLineToNode extends OoxmlElementBase<
  readonly [],
  readonly OoxmlKnownNodeAttribute[]
> {
...
interface OoxmlPictureNode extends OoxmlElementBase<
  readonly (
...
interface OoxmlPictureNvPicPrNode extends OoxmlElementBase<
  readonly OoxmlGenericElementNode[],
  readonly OoxmlKnownNodeAttribute[]
> {
...
interface OoxmlPictureBlipFillNode extends OoxmlElementBase<
  readonly (
...
interface OoxmlPictureBlipNode extends OoxmlElementBase<
  readonly [],
  readonly OoxmlKnownNodeAttribute[]
> {
...
interface OoxmlPictureSrcRectNode extends OoxmlElementBase<
  readonly [],
  readonly OoxmlKnownNodeAttribute[]
> {
...
interface OoxmlPictureStretchNode extends OoxmlElementBase<
  readonly OoxmlGenericElementNode[],
  readonly OoxmlKnownNodeAttribute[]
> {
...
interface OoxmlPictureTileNode extends OoxmlElementBase<
  readonly OoxmlGenericElementNode[],
  readonly OoxmlKnownNodeAttribute[]
> {
...
interface OoxmlPictureShapePropertiesNode extends OoxmlElementBase<
  readonly (
...
interface OoxmlPictureTransformNode extends OoxmlElementBase<
  readonly (
...
interface OoxmlPictureTransformOffsetNode extends OoxmlElementBase<
  readonly [],
  readonly OoxmlKnownNodeAttribute[]
> {
...
interface OoxmlPictureTransformExtentNode extends OoxmlElementBase<
  readonly [],
  readonly OoxmlKnownNodeAttribute[]
> {
...
interface OoxmlPicturePresetGeometryNode extends OoxmlElementBase<
  readonly OoxmlGenericElementNode[],
  readonly OoxmlKnownNodeAttribute[]
> {
 ...
 */
interface OoxmlDeletedTextNode extends OoxmlElementBase<
 ...
 */
interface OoxmlRunPropertiesNode extends OoxmlElementBase<
  readonly OoxmlGenericElementNode[],
  readonly OoxmlKnownNodeAttribute[]
> {
...
interface OoxmlTextElementNode extends OoxmlElementBase<
  readonly OoxmlTextNode[],
  readonly OoxmlKnownNodeAttribute[]
> {
  readonly kind: "text";
...
interface OoxmlParagraphPropertiesNode extends OoxmlElementBase<
...
interface OoxmlTabNode extends OoxmlElementBase<
  readonly [],
  readonly OoxmlKnownNodeAttribute[]
> {
  readonly kind: "tab";
...
interface OoxmlHardBreakNode extends OoxmlElementBase<
  readonly [],
  readonly OoxmlKnownNodeAttribute[]
> {
 ...
 */
interface OoxmlFldCharNode extends OoxmlElementBase<
  readonly OoxmlGenericElementNode[],
  readonly OoxmlKnownNodeAttribute[]
> {
 ...
 * keywords only.
 */
interface OoxmlInstrTextNode extends OoxmlElementBase<
  readonly OoxmlTextNode[],
  readonly OoxmlKnownNodeAttribute[]
> {
 ...
 */
interface OoxmlFldSimpleNode extends OoxmlElementBase<
 ...
 */
interface OoxmlFootnotesNode extends OoxmlElementBase<
 ...
 */
interface OoxmlEndnotesNode extends OoxmlElementBase<
  readonly (OoxmlNoteNode | OoxmlGenericElementNode)[],
  readonly OoxmlKnownNodeAttribute[]
> {
 ...
 */
interface OoxmlNoteNode extends OoxmlElementBase<
  readonly (OoxmlParagraphNode | OoxmlTableNode | OoxmlGenericElementNode)[],
  readonly OoxmlKnownNodeAttribute[]
> {
  readonly kind: "note";
 ...
 */
interface OoxmlNoteReferenceNode extends OoxmlElementBase<
  readonly [],
  readonly OoxmlKnownNodeAttribute[]
> {
 ...
 */
interface OoxmlNoteRefNode extends OoxmlElementBase<
  readonly [],
  readonly OoxmlKnownNodeAttribute[]
> {
...
interface OoxmlSeparatorNode extends OoxmlElementBase<
  readonly [],
  readonly OoxmlKnownNodeAttribute[]
> {
...
interface OoxmlContinuationSeparatorNode extends OoxmlElementBase<
  readonly [],
  readonly OoxmlKnownNodeAttribute[]
> {
 ...
 */
interface OoxmlContentControlNode extends OoxmlElementBase<
  readonly (
 ...
 */
interface OoxmlContentControlPropertiesNode extends OoxmlElementBase<
  readonly (
    | OoxmlRunPropertiesNode
...
interface OoxmlContentControlEndPropertiesNode extends OoxmlElementBase<
  readonly (OoxmlRunPropertiesNode | OoxmlGenericElementNode)[],
  readonly OoxmlKnownNodeAttribute[]
> {
 ...
 */
interface OoxmlContentControlContentNode extends OoxmlElementBase<
  readonly OoxmlNode[],
  readonly OoxmlKnownNodeAttribute[]
> {
...
interface OoxmlContentControlDropDownListNode extends OoxmlElementBase<
...
interface OoxmlContentControlComboBoxNode extends OoxmlElementBase<
  readonly (OoxmlContentControlListItemNode | OoxmlGenericElementNode)[],
  readonly OoxmlKnownNodeAttribute[]
> {
...
interface OoxmlContentControlListItemNode extends OoxmlElementBase<
  readonly [],
  readonly OoxmlKnownNodeAttribute[]
> {
 ...
 */
interface OoxmlContentControlDateNode extends OoxmlElementBase<
  readonly (
...
interface OoxmlContentControlDateFormatNode extends OoxmlElementBase<
  readonly [],
...
interface OoxmlContentControlLidNode extends OoxmlElementBase<
  readonly [],
  readonly (OoxmlKnownNodeAttribute | OoxmlWmlValAttribute)[]
> {
...
interface OoxmlContentControlStoreMappedDataAsNode extends OoxmlElementBase<
  readonly [],
  readonly (OoxmlKnownNodeAttribute | OoxmlWmlValAttribute)[]
> {
...
interface OoxmlContentControlCalendarNode extends OoxmlElementBase<
  readonly [],
  readonly (OoxmlKnownNodeAttribute | OoxmlWmlValAttribute)[]
> {
...
interface OoxmlContentControlTextNode extends OoxmlElementBase<
  readonly [],
  readonly OoxmlKnownNodeAttribute[]
> {
 ...
 */
interface OoxmlContentControlDataBindingNode extends OoxmlElementBase<
  readonly [],
  readonly OoxmlKnownNodeAttribute[]
> {
 ...
 */
interface OoxmlContentControlCheckboxNode extends OoxmlElementBase<
  readonly (
...
interface OoxmlContentControlCheckedNode extends OoxmlElementBase<
  readonly [],
  readonly OoxmlKnownNodeAttribute[]
> {
...
interface OoxmlContentControlCheckedStateNode extends OoxmlElementBase<
  readonly [],
  readonly OoxmlKnownNodeAttribute[]
> {
...
interface OoxmlContentControlUncheckedStateNode extends OoxmlElementBase<
  readonly [],
  readonly OoxmlKnownNodeAttribute[]
> {
 ...
 * never locks editing.
 */
interface OoxmlGenericElementNode extends OoxmlElementBase<
  readonly OoxmlNode[]
> {
 ...
 */
declare function readOoxmlPart(
  xml: string,
...
export {
  type OoxmlPartMetadata as $,
  type OoxmlBookmarkEndNode as A,
  type OoxmlBookmarkStartNode as B,
  type OoxmlContentControlCalendarNode as C,
  type OoxmlContentControlCheckboxNode as D,
  type OoxmlContentControlCheckedNode as E,
  type OoxmlContentControlCheckedStateNode as F,
  type OoxmlContentControlComboBoxNode as G,
  type OoxmlContentControlDataBindingNode as H,
  type OoxmlContentControlDateFormatNode as I,
  type OoxmlContentControlDateNode as J,
  type OoxmlContentControlDropDownListNode as K,
  type OoxmlContentControlLidNode as L,
  type OoxmlContentControlListItemNode as M,
  type OoxmlContentControlStoreMappedDataAsNode as N,
  type OoxmlNode as O,
  type OoxmlContentControlTextNode as P,
  type OoxmlContentControlUncheckedStateNode as Q,
  type OoxmlDocumentNode as R,
  type OoxmlGenericExtensionAttribute as S,
  type OoxmlHyperlinkNode as T,
  type OoxmlInvariantIssueCode as U,
  type OoxmlKnownNodeAttribute as V,
  type OoxmlNamespaceBinding as W,
  type XmlLimits as X,
  type OoxmlNodeId as Y,
  type OoxmlNodeIdentityRules as Z,
  type OoxmlParagraphPropertiesNode as _,
  type OoxmlElement as a,
  type OoxmlReadResult as a0,
  type OoxmlRunNode as a1,
  type OoxmlRunPropertiesNode as a2,
  type OoxmlTabNode as a3,
  type OoxmlTextElementNode as a4,
  type OoxmlTextNode as a5,
  type OoxmlWmlValAttribute as a6,
  type OoxmlXmlSpaceAttribute as a7,
  WML_NAMESPACE_URI as a8,
  XMLNS_NAMESPACE_URI as a9,
  XML_NAMESPACE_URI as aa,
  type XmlNode as ab,
  type XmlRejection as ac,
  type XmlResult as ad,
  childElements as ae,
  findElement as af,
  isContentRevisionKind as ag,
  isRangeMarkerKind as ah,
  readOnOffChild as ai,
  readOoxmlPart as aj,
  readXml as ak,
  textContent as al,
  type OoxmlContentControlNode as b,
  type OoxmlGenericElementNode as c,
  type OoxmlContentControlContentNode as d,
  type OoxmlPart as e,
  type OoxmlParagraphNode as f,
  type OoxmlNoteNode as g,
  type OoxmlContinuationSeparatorNode as h,
  type OoxmlEndnotesNode as i,
  type OoxmlFootnotesNode as j,
  type OoxmlNoteRefNode as k,
  type OoxmlNoteReferenceNode as l,
  type OoxmlSeparatorNode as m,
  type OoxmlReadRejection as n,
  type OoxmlContentControlEndPropertiesNode as o,
  type OoxmlContentControlPropertiesNode as p,
  type OoxmlDrawingNode as q,
  type OoxmlInvariantResult as r,
  type OoxmlInvariantIssue as s,
  type OoxmlHardBreakNode as t,
  type OoxmlFldCharNode as u,
  type OoxmlFldSimpleNode as v,
  type OoxmlInstrTextNode as w,
  type OoxmlAttribute as x,
  OOXML_NODE_IDENTITY_RULES as y,
  type OoxmlBodyNode as z,
};
