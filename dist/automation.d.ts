...
export {
  b as AUTOMATION_COMMAND_OPERATIONS,
  c as AUTOMATION_QUERY_OPERATIONS,
  d as AUTOMATION_SOLITARY_OPERATIONS,
  e as AutomationAlignment,
  f as AutomationBatchRequest,
  g as AutomationBatchResponse,
  h as AutomationChangeEvent,
  i as AutomationContentControlLock,
  j as AutomationContentControlRangeLocation,
  k as AutomationContentControlScope,
  l as AutomationContentControlSubtype,
  m as AutomationContentControlValue,
  n as AutomationError,
  o as AutomationErrorCode,
  p as AutomationFontRead,
  q as AutomationFontWrite,
  r as AutomationHandle,
  s as AutomationHandleRef,
  t as AutomationObjectKind,
  u as AutomationOperation,
  v as AutomationOperationKind,
  w as AutomationOperationResult,
  x as AutomationPageOrientation,
  y as AutomationPageSetupRead,
  z as AutomationPageSetupWrite,
  B as AutomationParagraphFormatRead,
  C as AutomationParagraphFormatWrite,
  D as AutomationParagraphRef,
  E as AutomationPoint,
  F as AutomationSaveResult,
  G as AutomationSearchOptions,
  H as AutomationSelectionMode,
  I as AutomationSpan,
  J as AutomationSpanRef,
  K as AutomationUnsubscribe,
  L as AutomationValue,
  M as isAutomationCommand,
  N as isSolitaryAutomationCommand,
} from "./protocol-ooK7PAXz.js";
...
type ServerAutomationHostRejection =
  OoxmlPackageRejection | "no-main-document-part";
/**
 ...
 */
declare function createServerAutomationHost(
  bytes: Uint8Array,
