...
import { I as ImageResourceState } from "./image-resources-e13t-pgy.js";
import { a as RevisionAttribution } from "./revision-projection-u4nT52xT.js";

/** Whether a paragraph must start a new page (`w:pageBreakBefore`). */
declare function paragraphBreaksBefore(
...
declare const PARAGRAPH_BORDER_SIDES: readonly [
  "top",
  "left",
  "bottom",
  "right",
 ...
 */
declare function paragraphSpacing(
  props: readonly OoxmlProperty[],
 ...
 */
declare function paragraphLineSpacing(
  props: readonly OoxmlProperty[],
 ...
 * sits on it.
 */
declare function applyLineSpacing(
 ...
 */
declare function paragraphContextualSpacing(
  props: readonly OoxmlProperty[],
): boolean;
/**
 ...
 */
declare function cascadedParagraphBorders(
 ...
 */
declare function paragraphBorderStrokeWidthPt(
 ...
 */
declare function collapsedSpaceBefore(
  before: number,
 ...
 */
declare function appliedSpaceBefore(
  before: number,
  previousAfter: number,
  atTopOfPage: boolean,
 ...
 */
declare function cascadedTabStops(
  paragraphPropertyNodes: readonly OoxmlNode[],
): ResolvedTabStops;
/** Direct `w:pPr` only — used when no style cascade table is present. */
declare function paragraphTabStops(
 ...
 */
declare function withDefaultTabInterval(
 ...
 */
declare function defaultTabIntervalFromSettings(
  settings: OoxmlNode | null | undefined,
): number;
 ...
 */
declare function nextTabDestination(
  tabs: ResolvedTabStops,
  currentX: number,
  rightEdge: number,
): TabDestination;
 ...
 */
declare function tabAdvanceWidth(
 ...
 */
declare function resolveRunStyle(
  props: readonly OoxmlProperty[],
 ...
 */
type TextboxStoryFallbackReason =
...
type AnchoredDrawingLayoutFallback =
  "unresolvable-frame" | "page-defer-exhausted";
interface AnchoredDrawingRecord extends Omit<
  InlineDrawingRecord,
  | "kind"
  | "baselineOffset"
  | "advanceStart"
...
declare function readBorderSide(
 ...
 */
declare function readTableBorders(
  tblPr: OoxmlElement | undefined,
): TableBorderBox;
 ...
 */
declare function resolveBorderConflict(
 ...
 */
declare function resolveTableCellBorderGrid(
...
declare function borderExtentPt(
 ...
 */
declare function paragraphFragmentsOf(
  page: PageRecord,
 ...
 */
declare function paragraphFragmentsOfBlocks(
 ...
 */
declare function unionLayoutBoxes(
  boxes: readonly LayoutBox[],
): LayoutBox | null;
/** Collapse raw + ancestor locks into one `ST_Lock` vocabulary value. */
declare function effectiveContentControlLock(
  locks: readonly ContentControlLock[],
): ContentControlLock;

export {
  PARAGRAPH_BORDER_SIDES as $,
  type AnchoredDrawingRecord as A,
  type BlockFragmentRecord as B,
  type ContentControlBoundaryRecord as C,
  type DrawingPoint as D,
  DEFAULT_TAB_INTERVAL_PT as E,
  type FieldLinkProjector as F,
  DEFAULT_TAB_INTERVAL_TWIPS as G,
  type HyperlinkProjector as H,
  type InlineDrawingRecord as I,
  EMPTY_TAB_STOPS as J,
  type FieldAtomMarker as K,
  type LineRecord as L,
  type ModelRange as M,
  type HeaderFooterStoryRecord as N,
  type HyperlinkFieldSpec as O,
  type PageGeometry as P,
  type LineSpacingRule as Q,
  type ResolvedRunStyle as R,
  type SemanticLayout as S,
  type TextMeasurer as T,
  type ListMarkerRecord as U,
  MAX_BORDER_SPACE_PT as V,
  MAX_BORDER_WIDTH_PT as W,
  MAX_PARAGRAPH_SPACING_PT as X,
  MAX_TABLE_BORDER_STROKES as Y,
  MAX_TAB_POSITION_TWIPS as Z,
  MAX_TAB_STOPS as _,
  type StyleSpanRecord as a,
  type ParagraphAutoSpacingContext as a0,
  type ParagraphBorderSide as a1,
  type ParagraphBorderStrokeRecord as a2,
  type ParagraphBottomBorderRecord as a3,
  type ParagraphIndent as a4,
  type ResolvedCellBorders as a5,
  type ResolvedTableBorderEdge as a6,
  type ResolvedTableBorderEdgeSegment as a7,
  type ResolvedUnderline as a8,
  SINGLE_LINE_SPACING as a9,
  linesOf as aA,
  measureDisplayText as aB,
  nextTabDestination as aC,
  paragraphBorderExtentPt as aD,
  paragraphBorderStrokeWidthPt as aE,
  paragraphBorders as aF,
  paragraphBordersFingerprint as aG,
  paragraphBreaksBefore as aH,
  paragraphContextualSpacing as aI,
  paragraphFragmentsOf as aJ,
  paragraphFragmentsOfBlocks as aK,
  paragraphLineSpacing as aL,
  paragraphSpacing as aM,
  paragraphTabStops as aN,
  readBorderSide as aO,
  readCellBorders as aP,
  readTableBorders as aQ,
  resolveBorderConflict as aR,
  resolveRunStyle as aS,
  resolveTableCellBorderGrid as aT,
  runStylesEqual as aU,
  tabAdvanceWidth as aV,
  tabStopsFingerprint as aW,
  unionLayoutBoxes as aX,
  withDefaultTabInterval as aY,
  type SourceRange as aa,
  type SpanLinkRecord as ab,
  TAB_LEADER_GLYPH as ac,
  type TabAlignment as ad,
  type TabDestination as ae,
  type TabLeader as af,
  type TabStop as ag,
  type TableBorderSideName as ah,
  type TableBorderStrokeRecord as ai,
  type TableFragmentRecord as aj,
  type VerticalAlign as ak,
  appliedSpaceBefore as al,
  applyLineSpacing as am,
  baselineShiftPtOf as an,
  borderExtentPt as ao,
  borderWeight as ap,
  bottomBorderExtentPt as aq,
  cascadedParagraphBorders as ar,
  cascadedTabStops as as,
  collapsedSpaceBefore as at,
  contentControlsOfLayout as au,
  defaultTabIntervalFromSettings as av,
  displayText as aw,
  effectiveContentControlLock as ax,
  fragmentsOfParagraph as ay,
  lineAtPosition as az,
  type TableRowFragmentRecord as b,
  type TableCellFragmentRecord as c,
  type LayoutBox as d,
  type DrawingInsets as e,
  type ThemeFonts as f,
  type ParagraphSpacing as g,
  type ParagraphLineSpacing as h,
  type ParagraphBorderEdge as i,
  type ParagraphBorders as j,
  type ResolvedTabStops as k,
  type TableBorderSide as l,
  type InlineDrawingLayoutContext as m,
  type PageRecord as n,
  type ParagraphFragmentRecord as o,
  type StoryPageFieldNeeds as p,
  type CellBorderBox as q,
  type TableBorderBox as r,
  AUTO_PARAGRAPH_SPACING_PT as s,
  type BorderGridGeometry as t,
  type ContentControlGeometryFragment as u,
  type ContentControlLevel as v,
  type ContentControlLock as w,
  type ContentControlMappedType as x,
  DEFAULT_PAGE_GEOMETRY as y,
  DEFAULT_RUN_STYLE as z,
};
