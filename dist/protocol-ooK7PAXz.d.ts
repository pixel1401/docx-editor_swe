import { H as HeaderFooterVariant } from "./hf-references-CAp1xTv6.js";
...
type AutomationContentControlRangeLocation =
  "whole" | "content" | "start" | "end" | "before" | "after";
...
declare const AUTOMATION_QUERY_OPERATIONS: readonly [
  "getDocument",
  "getBody",
  "getParagraphs",
  "getSpanParagraphs",
 ...
 */
declare const AUTOMATION_SOLITARY_OPERATIONS: readonly [
  "deleteNote",
  "insertComment",
  "setCommentResolved",
  "replyToComment",
...
declare function isSolitaryAutomationCommand(
...
interface AutomationHandle<
  K extends AutomationObjectKind = AutomationObjectKind,
> {
  readonly kind: K;
...
interface AutomationHost {
  ...
  subscribe(
    listener: (event: AutomationChangeEvent) => void,
...
export {
  type AutomationCapabilities as A,
  type AutomationParagraphFormatRead as B,
  type AutomationParagraphFormatWrite as C,
  type AutomationParagraphRef as D,
  type AutomationPoint as E,
  type AutomationSaveResult as F,
  type AutomationSearchOptions as G,
  type AutomationSelectionMode as H,
  type AutomationSpan as I,
  type AutomationSpanRef as J,
  type AutomationUnsubscribe as K,
  type AutomationValue as L,
  isAutomationCommand as M,
  isSolitaryAutomationCommand as N,
  type AutomationHost as a,
  AUTOMATION_COMMAND_OPERATIONS as b,
  AUTOMATION_QUERY_OPERATIONS as c,
  AUTOMATION_SOLITARY_OPERATIONS as d,
  type AutomationAlignment as e,
  type AutomationBatchRequest as f,
  type AutomationBatchResponse as g,
  type AutomationChangeEvent as h,
  type AutomationContentControlLock as i,
  type AutomationContentControlRangeLocation as j,
  type AutomationContentControlScope as k,
  type AutomationContentControlSubtype as l,
  type AutomationContentControlValue as m,
  type AutomationError as n,
  type AutomationErrorCode as o,
  type AutomationFontRead as p,
  type AutomationFontWrite as q,
  type AutomationHandle as r,
  type AutomationHandleRef as s,
  type AutomationObjectKind as t,
  type AutomationOperation as u,
  type AutomationOperationKind as v,
  type AutomationOperationResult as w,
  type AutomationPageOrientation as x,
  type AutomationPageSetupRead as y,
  type AutomationPageSetupWrite as z,
};
