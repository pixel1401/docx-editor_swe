import { e as ResourceLimits } from "./image-resources-e13t-pgy.js";
export {
  C as CreateImageResourceCacheOptions,
  D as DEFAULT_IMAGE_RESOURCE_LIMITS,
  f as DEFAULT_LIMITS,
  H as HARD_CEILINGS,
  g as IMAGE_RESOURCE_HARD_CEILINGS,
  b as ImageDecodePort,
  c as ImageResourceLimits,
  h as ImageResourceLookup,
  I as ImageResourceState,
  M as MAX_SVG_SNIFF_BYTES,
  P as PreservedImageMime,
  S as SupportedImageMime,
  i as ValidatedRasterHeader,
  j as createImageResourceCache,
  k as hasBoundedSvgRoot,
  l as imageResourceLookupFor,
  m as liveDrawingReferenceCount,
  r as resolveImageResourceLimits,
  n as resolveLimits,
  s as sniffImageMime,
  o as validateGifHeader,
  p as validateJpegHeader,
  q as validatePngHeader,
  v as validateRasterHeader,
} from "./image-resources-e13t-pgy.js";
import {
  O as OoxmlPackage,
  R as RelationshipRecord,
} from "./ooxml-package-BrxTmTsZ.js";
export {
  C as ContentTypeError,
  c as ContentTypeIndex,
  d as ContentTypeRecords,
  D as DEFAULT_OOXML_PACKAGE_LIMITS,
  e as DEFAULT_ZIP_LIMITS,
  f as DefaultRecord,
  I as IMAGE_RELATIONSHIP_TYPE,
  g as ImageRelationshipResolution,
  h as IndexResult,
  N as NameRejection,
  i as NameResult,
  j as OoxmlExternalTarget,
  a as OoxmlPackageLimits,
  b as OoxmlPackageRejection,
  k as OoxmlPackageResult,
  l as OverrideRecord,
  m as RelationshipError,
  n as RelationshipSetResult,
  o as ResolveResult,
  p as ResolvedRelationship,
  T as TargetMode,
  Z as ZipLimits,
  q as ZipReadResult,
  r as ZipRejection,
  s as asciiFold,
  t as buildContentTypeIndex,
  u as buildRelationshipSet,
  v as detectDuplicateNames,
  w as extensionKey,
  x as isValidMime,
  y as normalizePartName,
  z as partNameKey,
  A as readOoxmlPackage,
  B as readZip,
  E as resolveContentType,
  F as resolveImageRelationship,
  G as resolveInternalTarget,
  H as resolveRelationship,
  J as validateExternalTarget,
  K as withPart,
  L as writeOoxmlPackage,
  M as writeZip,
} from "./ooxml-package-BrxTmTsZ.js";
import {
  e as OoxmlPart,
  O as OoxmlNode,
  r as OoxmlInvariantResult,
  s as OoxmlInvariantIssue,
  a as OoxmlElement,
  f as OoxmlParagraphNode,
  t as OoxmlHardBreakNode,
  u as OoxmlFldCharNode,
  v as OoxmlFldSimpleNode,
  w as OoxmlInstrTextNode,
  x as OoxmlAttribute,
} from "./ooxml-tree-CG0odFyi.js";
export {
  y as OOXML_NODE_IDENTITY_RULES,
  z as OoxmlBodyNode,
  A as OoxmlBookmarkEndNode,
  B as OoxmlBookmarkStartNode,
  C as OoxmlContentControlCalendarNode,
  D as OoxmlContentControlCheckboxNode,
  E as OoxmlContentControlCheckedNode,
  F as OoxmlContentControlCheckedStateNode,
  G as OoxmlContentControlComboBoxNode,
  d as OoxmlContentControlContentNode,
  H as OoxmlContentControlDataBindingNode,
  I as OoxmlContentControlDateFormatNode,
  J as OoxmlContentControlDateNode,
  K as OoxmlContentControlDropDownListNode,
  ...
  N as OoxmlContentControlStoreMappedDataAsNode,
  P as OoxmlContentControlTextNode,
  Q as OoxmlContentControlUncheckedStateNode,
  h as OoxmlContinuationSeparatorNode,
  R as OoxmlDocumentNode,
  i as OoxmlEndnotesNode,
  j as OoxmlFootnotesNode,
  c as OoxmlGenericElementNode,
  S as OoxmlGenericExtensionAttribute,
  T as OoxmlHyperlinkNode,
  U as OoxmlInvariantIssueCode,
  V as OoxmlKnownNodeAttribute,
  W as OoxmlNamespaceBinding,
  Y as OoxmlNodeId,
  Z as OoxmlNodeIdentityRules,
  g as OoxmlNoteNode,
  k as OoxmlNoteRefNode,
  l as OoxmlNoteReferenceNode,
  _ as OoxmlParagraphPropertiesNode,
  $ as OoxmlPartMetadata,
  n as OoxmlReadRejection,
  a0 as OoxmlReadResult,
  a1 as OoxmlRunNode,
  a2 as OoxmlRunPropertiesNode,
  m as OoxmlSeparatorNode,
  a3 as OoxmlTabNode,
  a4 as OoxmlTextElementNode,
  a5 as OoxmlTextNode,
  a6 as OoxmlWmlValAttribute,
  a7 as OoxmlXmlSpaceAttribute,
  a8 as WML_NAMESPACE_URI,
  a9 as XMLNS_NAMESPACE_URI,
  aa as XML_NAMESPACE_URI,
  X as XmlLimits,
  ab as XmlNode,
  ac as XmlRejection,
  ad as XmlResult,
  ae as childElements,
  af as findElement,
  ag as isContentRevisionKind,
  ah as isRangeMarkerKind,
  ai as readOnOffChild,
  aj as readOoxmlPart,
  ak as readXml,
  al as textContent,
} from "./ooxml-tree-CG0odFyi.js";
export {
  e as BookmarkAnchor,
  B as BookmarkIndex,
  f as CascadeDeletedNoteReferencesOptions,
  g as CustomNodePayloadRead,
  h as CustomNodePayloadWrite,
  b as CustomNodeSweepOutcome,
  i as CustomNodeSweepResult,
  j as CustomNodeWriteRejection,
  C as CustomNodeWriteResult,
  k as DEFAULT_MAX_EDITABLE_STORY_PARTS,
  D as DocumentTrackingSettings,
  l as DrawingPropertyIdResult,
  E as EmbeddedFont,
  F as FontStyleKey,
  H as HeaderFooterLifecycleImpact,
  m as HeaderFooterLifecycleOp,
  n as HeaderFooterLifecycleRejection,
  o as HeaderFooterLifecycleResult,
  I as InsertCustomNodeWrite,
  L as ListKind,
  M as MAX_CUSTOM_NODE_LABEL_LENGTH,
  p as MAX_CUSTOM_NODE_PAYLOAD_LENGTH,
  q as MAX_NOTE_REFERENCE_PARTS,
  r as MAX_NOTE_REFERENCE_SCAN,
  N as NO_TRACKING_SETTINGS,
  s as NoteDiagnostic,
  t as NoteDiagnosticCode,
  u as NoteLifecycleImpact,
  v as NoteLifecycleOp,
  w as NoteLifecycleOptions,
  x as NoteLifecycleRejection,
  y as NoteLifecycleResult,
  z as NoteReferenceHit,
  G as NoteReferenceScanBudget,
  P as PackageTransactResult,
  J as ReadEmbeddedFontsOptions,
  K as StoryResolveResult,
  S as StoryScope,
  a as StoryTargetRejection,
  T as TreePackageStore,
  O as TreePackageStoreOptions,
  Q as allocateDrawingPropertyId,
  U as applyHeaderFooterLifecycleOp,
  V as applyNoteLifecycleOp,
  W as buildBookmarkIndex,
  X as cascadeDeletedNoteReferences,
  Y as collectNoteReferences,
  Z as collectPackageNoteReferences,
  _ as createNoteReferenceScanBudget,
  $ as customNodePayloadsByControl,
  a0 as customNodePayloadsOf,
  a1 as deobfuscateFont,
  a2 as diagnoseNoteReferences,
  a3 as ensureListDefinition,
  a4 as ensureNumberingLevel,
  a5 as insertCustomNodeWrite,
  a6 as isHeaderFooterLifecycleOp,
  a7 as isNoteLifecycleOp,
  a8 as normalNoteIds,
  a9 as notesPartHasId,
  aa as readEmbeddedFonts,
  ab as readTrackingSettings,
  ac as removeCustomNodeWrite,
  ad as resolveNotesPart,
  ae as sweepCustomNodePayloads,
  af as withBinaryPart,
  ag as withEmbeddedImage,
  ah as withoutUnreferencedImagePart,
} from "./custom-node-writes-2clI36T9.js";
export {
  c as HeaderFooterKind,
  a as HeaderFooterParts,
  b as HeaderFooterSectionResolution,
  d as HeaderFooterSlotMeta,
  H as HeaderFooterVariant,
  e as collectSectionPropertyNodes,
  r as resolveHeaderFooterParts,
  f as resolveHeaderFooterPartsBySection,
  g as resolveHeaderFooterResolutionBySection,
} from "./hf-references-CAp1xTv6.js";
export {
  c as collectFlowBlocks,
  d as contentControlContentOf,
  i as isContentControl,
  b as isContentControlContent,
  w as walkAllStoryParagraphs,
  e as walkParagraphInline,
  f as walkStoryBlocks,
} from "./content-control-walk-CQp8l6eS.js";
import {
  T as TreeDocOp,
  a as TreeOpRejection,
  q as TreeOpResult,
  O as OoxmlProperty,
  j as DrawingTreeDocOp,
  I as ImpactClass,
  b as ImageWrapTarget,
} from "./tree-op-types-CZw9QhWX.js";
export {
  A as ACCEPTED_PARAGRAPH_PROPERTIES,
  r as ACCEPTED_RUN_PROPERTIES,
  s as CONTENT_CONTROL_ID_MAX,
  t as CONTENT_CONTROL_PROPERTY_ORDER,
  u as ContentControlCheckbox,
  v as ContentControlCheckboxState,
  p as ContentControlDataBinding,
  w as ContentControlDateFormat,
  x as ContentControlEntry,
  C as ContentControlKind,
  n as ContentControlLevel,
  y as ContentControlListItem,
  o as ContentControlLock,
  z as ContentControlProperties,
  c as DrawingKind,
  e as DrawingLocks,
  d as DrawingPositionInput,
  H as HYPERLINK_RELATIONSHIP_TYPE,
  B as HyperlinkKind,
  E as HyperlinkTarget,
  i as IMAGE_WRAP_TARGETS,
  M as MAX_CONTENT_CONTROLS_PER_PART,
  F as MAX_CONTENT_CONTROL_NESTING,
  G as OFFICE_RELATIONSHIP_NAMESPACE_URI,
  J as RelationshipTargetResolver,
  R as RevisionAddress,
  S as SourceCrop,
  K as TABLE_BORDER_STYLES,
  L as TREE_DOC_OP_KINDS,
  m as TableBorderStyle,
  N as TreeDocOpKind,
  P as TreeOpEffect,
  Q as allocateContentControlId,
  U as contentControlContentChildren,
  W as contentControlContentNodeOf,
  X as contentControlEndPropertiesNodeOf,
  Y as contentControlLevelOf,
  Z as contentControlPropertiesNodeOf,
  _ as contentControlPropertiesOf,
  $ as contentControlTextOf,
  a0 as contentControlsIn,
  a1 as findContentControl,
  a2 as flattenContentControls,
  a3 as hyperlinkAnchorOf,
  a4 as hyperlinkRelationshipIdOf,
  a5 as hyperlinkTargetOf,
  a6 as isContentControlContentNode,
  a7 as isContentControlNode,
  a8 as isContentControlWrapper,
  a9 as isHyperlinkNode,
  aa as lockForbidsEdit,
  ab as lockForbidsRemoval,
  ac as orderedContentControlProperties,
  ad as parseContentControlId,
  ae as projectDrawing,
  af as resolveContentControlLock,
} from "./tree-op-types-CZw9QhWX.js";
export {
  A as AtomicNoteSpan,
  M as MAX_NOTES_PER_PART,
  a as NOTE_ATOM_CHAR,
  b as NOTE_CONTINUATION_SEPARATOR_ID,
  c as NOTE_ID_MAX,
  d as NOTE_ID_MIN,
  e as NOTE_SEPARATOR_ID,
  N as NoteKind,
  f as NoteType,
  g as allocateNoteId,
  h as atomicNoteSpansOf,
  i as customMarkFollows,
  j as findNoteById,
  k as formatNoteScopeId,
  l as isContinuationSeparatorNode,
  m as isEndnotesNode,
  ...
  r as isNoteNode,
  s as isNoteRefNode,
  t as isNoteReferenceNode,
  u as isSeparatorNode,
  v as noteAtomText,
  w as noteIdOf,
  x as noteKindOf,
  y as noteRefKindOf,
  z as noteReferenceKindOf,
  n as noteTypeOf,
  B as notesOf,
  C as parseNoteId,
  D as parseNoteScopeId,
} from "./note-nodes-CZQXU6Fg.js";
export {
  A as AuthoredNoteProperties,
  C as CommentAnchor,
  b as CommentPosition,
  c as CommentRecord,
  d as CommentThreadState,
  D as DEFAULT_ENDNOTE_PROPERTIES,
  e as DEFAULT_FOOTNOTE_PROPERTIES,
  E as EndnotePosition,
  F as FootnotePosition,
  L as LinkableReviewItem,
  N as NoteNumRestart,
  a as ResolvedEndnoteProperties,
  R as ResolvedFootnoteProperties,
  f as ReviewCommentItem,
  g as ReviewItem,
  h as ReviewModelInput,
  i as ReviewPosition,
  j as ReviewRange,
  k as ReviewRevisionItem,
  l as ReviewRevisionKind,
  W as W15_NAMESPACE_URI,
  m as authoredDocumentEndnoteProperties,
  n as authoredDocumentFootnoteProperties,
  o as authoredEndnotePropertiesFromSectPr,
  q as authoredFootnotePropertiesFromSectPr,
  r as collectReviewItems,
  s as commentAnchorsOfStory,
  t as commentBodyText,
  u as commentInitials,
  v as commentItemsOf,
  w as commentsOfPart,
  x as deepParagraphOrderOfPart,
  y as firstReviewRange,
  z as hasAnyComment,
  B as isLegalEndnotePosition,
  G as isLegalFootnotePosition,
  H as isLegalNumRestart,
  I as linkRevisionReplies,
  p as paragraphOrderOfPart,
  J as parseAuthoredNoteProperties,
  K as resolveEndnoteProperties,
  M as resolveFootnoteProperties,
  O as reviewItemKey,
  P as reviewItemRanges,
  Q as revisionItemsOf,
  S as settingsPartOf,
  T as threadStateOfPart,
} from "./note-properties-BS66XmcC.js";
import {
  T as TreeModelChange,
  b as TreeDocumentStore,
} from "./tree-store-9TaX-L0V.js";
export {
  D as DocumentProperties,
  S as SelectionMark,
  f as TreeDocumentStoreOptions,
  a as TreeStoryRef,
  d as TreeTransactOptions,
  g as TreeTransactResult,
  c as TreeTransactionContext,
} from "./tree-store-9TaX-L0V.js";
...
declare function canonicalOoxmlFingerprint(
 ...
 */
declare function ooxmlTreesEqual(
...
declare function parentNodeOf(
  part: OoxmlPart,
  nodeId: string,
): OoxmlElement | null;
/** Replace one node's children wholesale. */
declare function replaceChildren(
  part: OoxmlPart,
  nodeId: string,
...
declare function insertChildren(
  part: OoxmlPart,
  nodeId: string,
  index: number,
  children: readonly OoxmlNode[],
 ...
 */
declare function paragraphOffsetIndex(
 ...
 */
declare const ID_KINDS: readonly [
  "extension",
  "capability",
  "command",
  "query",
...
declare function makeLimitCounter(
 ...
 */
type ComparatorMode =
  "canonical-exact" | "exact" | "tolerance" | "sync-optimization-only";
 ...
 */
declare function compareArtifacts(
  name: ComparatorName,
  left: unknown,
  right: unknown,
  opts?: {
 ...
 */
declare function replayFixture(
 ...
 */
declare function withContentTypeOverride(
  pkg: OoxmlPackage,
  partName: string,
  contentType: string,
  options?: {
...
declare function withRelationship(
  pkg: OoxmlPackage,
  ownerPart: string,
  type: string,
  rawTarget: string,
 ...
 */
declare function validatePackageInvariants(
  pkg: OoxmlPackage,
): PackageInvariantResult;
 ...
 */
declare const INERT_EXECUTABLE_KINDS: readonly [
  "field-dde",
  "field-include",
  "macro",
  "activex",
...
declare function hardBreakAttributes(
  kind: "line" | "page",
): OoxmlHardBreakNode["attributes"];
 ...
 */
declare function fieldOnOffAttribute(
  node: OoxmlNode,
...
declare function atomicFieldSpansOf(
  paragraph: OoxmlParagraphNode,
  options?: {
...
declare function findDetectedToc(
  tocs: readonly DetectedToc[],
  tocId: string,
): DetectedToc | null;
...
declare function buildTocEntryParagraph(
  mint: () => string,
  entry: TocEntryPlan,
...
declare function buildTocContentControl(
  mint: () => string,
 ...
 */
declare function planTocEntries(
  part: OoxmlPart,
...
declare function bookmarkPairNodes(
  mint: () => string,
  name: string,
  id: string,
): {
 ...
 */
declare function resolveTocRowHeadings(
  part: OoxmlPart,
  toc: DetectedToc,
  outline: readonly TocOutlineHeading[],
  excludeParagraphIds: ReadonlySet<string>,
...
declare function indexStyles(
  part: OoxmlPart | undefined,
): Map<string, StyleIndexEntry>;
 ...
 */
declare function deriveOoxmlIndexes(
  pkg: OoxmlPackage,
  revision: number,
): OoxmlIndexes;
 ...
 */
declare function diffSemanticDigests(
...
declare function mintedParagraphIdentityAttributes(
  prefix: string,
  value: string,
 ...
 */
declare function ensureHyperlinkRelationship(
  pkg: OoxmlPackage,
  url: string,
  ownerPart?: string,
 ...
 */
declare function relationshipTargetIn(
  pkg: OoxmlPackage,
  ownerPart: string,
 ...
 */
declare function deleteCommentThread(
  pkg: OoxmlPackage,
  commentId: string,
 ...
 */
declare function cascadeEmptiedComments(
  before: OoxmlPackage,
  after: OoxmlPackage,
  owner?: CommentDeletionOwner,
): OoxmlPackage | null;
...
declare function readViewSettings(
 ...
 * copy of it.
 */
declare function collectStoryParagraphs(
  children: readonly OoxmlNode[],
  out: OoxmlNode[],
  sdtDepth: number,
): void;
 ...
 * never sees.
 */
declare function withCustomXmlDataPart(
  pkg: OoxmlPackage,
  storyPartName: string,
  namespaceUri: string,
 ...
 */
declare function withoutCustomXmlDataPart(
  pkg: OoxmlPackage,
  storyPartName: string,
  namespaceUri: string,
): WithoutPartResult;
...
declare function customXmlNodes(
  pkg: OoxmlPackage,
  partName: string,
): CustomXmlNode[];
/** One node by id, or null. */
declare function readCustomXmlNode(
  pkg: OoxmlPackage,
  partName: string,
  nodeId: string,
): CustomXmlNode | null;
 ...
 */
declare function withCustomXmlNode(
  pkg: OoxmlPackage,
  partName: string,
  node: CustomXmlNode,
): OoxmlPackage;
/** Drop one node by id. A store that never held it comes back unchanged. */
declare function withoutCustomXmlNode(
  pkg: OoxmlPackage,
  partName: string,
  nodeId: string,
): OoxmlPackage;
 ...
 */
declare function withoutOrphanCustomXmlNodes(
  pkg: OoxmlPackage,
  partName: string,
 ...
 */
declare function customXmlLabelXPath(
  prefix: string,
  rootLocalName: string,
  nodeId: string,
): string | null;
...
declare function customXmlPrefixMappings(
  prefix: string,
  namespaceUri: string,
): string | null;
 ...
 */
declare function customNodeBinding(
 ...
 */
declare function boundCustomXmlNodeIds(
  part: OoxmlPart,
  storeItemId: string,
): Set<string>;
/**
 ...
 */
declare function withExportedCustomNodes(
  pkg: OoxmlPackage,
 ...
 */
declare function commentsExtendedPartNameOf(
  pkg: OoxmlPackage,
  storyPartName: string,
): string;
 ...
 */
declare function propertyContainer(
...
declare function authoredProperties(
 ...
 * exactly as authored.
 */
declare function directParagraphProperties(
  part: OoxmlPart,
  paragraphId: string,
): readonly OoxmlProperty[];
/**
 ...
 */
declare function directParagraphMarkProperties(
  part: OoxmlPart,
  paragraphId: string,
): readonly OoxmlProperty[];
/**
 ...
 */
declare function mergedProperties(
...
declare function runAddressRanges(
  paragraph: Extract<
    OoxmlNode,
    {
      kind: "paragraph";
...
declare function formatOwnedRunIds(
  paragraph: Extract<
    OoxmlNode,
    {
      kind: "paragraph";
 ...
 */
declare function runPropertyEdits(
  part: OoxmlPart,
  paragraphId: string,
  start: number,
  end: number,
 ...
 */
declare function findOccurrences(
  text: string,
  query: string,
  limit: number,
...
declare function validateDrawingOp(
  part: OoxmlPart,
  op: DrawingTreeDocOp,
): TreeOpRejection | null;
