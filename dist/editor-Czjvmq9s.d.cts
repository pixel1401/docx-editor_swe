...
import { g as ReviewRevisionKind, c as ReviewCommentItem, b as ReviewRevisionItem, d as ReviewCustomItem } from './review-support-CHuJxHmz.cjs';
import { a as SemanticSelection, S as SemanticPosition } from './semantic-interaction-DgaWs-5w.cjs';
...
import { S as SourceCrop, b as ImageWrapTarget, c as DrawingKind, d as DrawingPositionInput, e as DrawingLocks } from './tree-op-types-DOYNkKqD.cjs';
import { S as SupportedImageMime, I as ImageResourceState } from './image-resources-CSlQmPIm.cjs';
 ...
 */
type EditorFontErrorCode = 'initializationFailed' | 'wasmUnavailable' | 'missing' | 'forbidden' | 'overLimit' | 'malformed' | 'hashMismatch' | 'metadataMismatch' | 'fontFaceLoadFailed' | 'unsupportedFaceIndex' | 'missingFont' | 'hashInvalid' | 'fontMismatch' | 'unsupportedFace' | 'loadFailed';
 ...
 */
interface EditorCommands extends EditorCommandShape<DocEdits>, EditorHeaderFooterCommands, EditorNoteCommands, EditorFieldSdtCommands {
...
export { type NotePropertiesSide as $, type AuthoredNoteNumbering as A, type EditorHeaderFooterCommands as B, type CanResult as C, type DocumentSource as D, EditorFontError as E, type FontConfiguration as F, type EditorNoteCommands as G, type EditorPosition as H, type ImageContext as I, type EditorQueries as J, type EditorQuery as K, type EditorQueryResults as L, type EditorScope as M, type EditorSelection as N, type EditorSnapshot as O, type FurnitureVariant as P, type HeaderFooterSlotArgs as Q, type HeaderFooterState as R, type SelectedImageState as S, type TableBorderEdgeTarget as T, type HyperlinkInfo as U, type ViewScope as V, type InteractionAffinity as W, type InteractionOutcome as X, type InteractionOutcomeCode as Y, type ZoomMode as Z, type NoteKind as _, type EditorCommand as a, type NotePropertiesState as a0, type PageSetup as a1, type ResolvedNoteNumbering as a2, type ReviewActivationOptions as a3, type ReviewCommentPlacement as a4, type ReviewCustomPlacement as a5, type ReviewItemPlacement as a6, type ReviewItemPlacementBase as a7, type ReviewItemQuery as a8, type ReviewRevisionPlacement as a9, type SemanticIdentity as aa, type SemanticTarget as ab, type TableBorderTarget as ac, type TableCellVerticalAlignment as ad, type TableColumnDividerResizeTarget as ae, type TableColumnOccurrenceTarget as af, type TableRightEdgeResizeTarget as ag, type TableRowOccurrenceTarget as ah, type TextMatch as ai, type ZoomFitTarget as aj, type ImageCropPercent as b, type ImageCropPermille as c, cropPercentFromCropPermille as d, cropPercentFromPermille as e, cropPercentFromSourceCrop as f, cropPermilleFromCropPercent as g, cropPermilleFromPercent as h, type FontSource as i, type FontSourceSubstitution as j, type FontFaceRequest as k, type Editor as l, type TableBorderSpec as m, type TableBorderStyle as n, type TableContext as o, type DocumentChange as p, type DocumentEditingMode as q, type DocumentHandle as r, sourceCropFromCropPercent as s, type EditorCommandShape as t, type EditorCommands as u, validateImageCropPercent as v, type EditorError as w, type EditorEvents as x, type EditorFieldSdtCommands as y, type EditorFontErrorCode as z };
