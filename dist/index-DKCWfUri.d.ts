...
import {
  c as RevisionStyles,
  R as ReviewAuthorInfo,
  b as RevisionAuthorStyle,
  F as FieldShadingMode,
  d as DrawingPaintStrings,
} from "./semantic-paint-eMO8cGZx.js";
import {
  Unsubscribe,
  ExecResult,
  IndentFormatting,
 ...
 */
declare function composeFontConfiguration(
 ...
 */
declare function createFontSource(
  bytes: Uint8Array,
...
interface ChromeGroup<
  ...
  ControlId extends string = string,
> {
 ...
 * @public
 */
declare function formattingBarChromeGroups(
  image: ImageContext | null,
): readonly ChromeGroup[];
/**
...
type ChromeMenuEntry =
  ChromeMenuItemEntry | ChromeMenuSubmenuEntry | ChromeMenuSeparatorEntry;
/**
 ...
 */
declare function selectedImageStateOf(
 ...
 */
declare function captureImageMutationPreconditions(
 ...
 */
declare function canExecuteImageCommand(
  command: Extract<
    EditorCommand,
    {
 ...
 */
declare function executeImageCommand(
 ...
 */
declare function selectedDrawingOverlayTargetOf(
  surface: PaginatedSurface | null,
 ...
 */
declare function computeResizedImageExtentEmu(
 ...
 */
declare function computeMovedImagePosition(
 ...
 */
declare function isStaleImageInteractionCommit(
  editor: Pick<DocxEditorInstance, "surface" | "mountGeneration">,
...
declare function overlayFrameToSheetCssPixels(
...
declare function resizePreservesAspect(
  handle: ImageResizeHandle,
 ...
 * page travelled.
 */
declare function createImageOverlayScrollPort(
...
interface PaginatedSurface {
  ...
  insertImage(
    input: Omit<InsertImageInput, "decodePort">,
...
type TableInteractionLabelKey =
  "table.insertRowBelow" | "table.insertColumnRight";
/**
...
declare function isTableChromeSlot(
  slot: ChromeSlotId,
): slot is TableChromeSlotId;
/** Contextual table chrome is visible when the engine reports table context. */
declare function tableChromeVisible(
  table: TableContext | null | undefined,
): boolean;
 ...
 */
declare function applyTableChromePick(
...
declare function probeTableChromeCommand(
  slot: TableChromeSlotId,
  draft?: TableChromeDraft,
): EditorCommand | null;
/**
 ...
 */
declare function tableChromeLabelKeyForTarget(
  target: TableBorderEdgeTarget,
): string;
/** Material Symbol paths for one table chrome icon name. */
declare function tableChromeIconPaths(
  name: keyof typeof GENERATED_ICON_PATHS,
): readonly string[];
 ...
 * @public
 */
declare function commandForTableChromeSlotValue(
 ...
 * @public
 */
declare function commandForSlotValue(
  slotId: ChromeSlotId,
  value: unknown,
): EditorCommand | null;
/**
 ...
 * @public
 */
declare function tableChromeToolbarState(
  editor: Editor | null,
  slot: TableChromeSlotId,
  draft?: TableChromeDraft,
): ToolbarCommandState;
 ...
 * @public
 */
declare function toolbarCommandState(
  editor: Editor | null,
  id: ChromeSlotId,
): ToolbarCommandState;
/**
 ...
 * @public
 */
declare function toolbarCommandStates(
  editor: Editor | null,
 ...
 * @public
 */
declare function runTableChromeCommand(
  editor: Editor | null,
  slot: TableChromeSlotId,
  value: unknown,
  draft: TableChromeDraft,
 ...
 * @public
 */
declare function runToolbarCommand(
  editor: Editor | null,
  id: ChromeSlotId,
 ...
 * @public
 */
declare function tableCommandToolbarState(
  surface: PaginatedSurface | null,
 ...
 * @public
 */
declare function runTableCommand(
  editor: Editor | null,
  command: EditorCommand,
): ExecResult;
...
export {
  TABLE_BORDER_STYLE_OPTIONS as $,
  type AnchorFrameOrigin as A,
  type HyperlinkOps as B,
  CHROME_GROUPS as C,
  type DocxEditorInstance as D,
  EMU_PER_POINT as E,
  type FinalizedImageOverlayInteraction as F,
  IMAGE_OVERLAY_NUDGE_SHIFT_PT as G,
  type HyperlinkActivation as H,
  IMAGE_OVERLAY_NUDGE_PT as I,
  type ImageInteractionSession as J,
  type ImageOverlayScrollPort as K,
  type ImageResizeHandle as L,
  type ImageResizeResult as M,
  type LoadFontsRequest as N,
  type OpenPaginatedResult as O,
  type PaginatedSurfaceOptions as P,
  type LoadFontsResult as Q,
  MAX_RESOLVER_FAMILIES as R,
  type OverlayFrameRect as S,
  type TableCommandPlan as T,
  type PaginatedSurfaceState as U,
  type RunTableChromeCommandResult as V,
  type SelectedDrawingOverlayTarget as W,
  type SurfaceFormatting as X,
  type SurfaceHyperlink as Y,
  type SurfaceNavigation as Z,
  type SurfaceOverlayCoordinates as _,
  type PaginatedSurface as a,
  TABLE_BORDER_TARGET_OPTIONS as a0,
  TABLE_BORDER_WIDTH_OPTIONS as a1,
  TABLE_CHROME_SLOT_IDS as a2,
  type TableBorderStyleOption as a3,
  type TableBorderTargetOption as a4,
  type TableBorderTargetValue as a5,
  type TableBorderWidthOption as a6,
  type TableChromeDraft as a7,
  type TableChromePick as a8,
  type TableChromeSlotId as a9,
  finalizeImageOverlayInteraction as aA,
  formattingBarChromeGroups as aB,
  isStaleImageInteractionCommit as aC,
  isTableChromeSlot as aD,
  layoutPointsToCssPixels as aE,
  loadFonts as aF,
  overlayFrameToSheetCssPixels as aG,
  pointsToEmu as aH,
  probeTableChromeCommand as aI,
  resizePreservesAspect as aJ,
  runSave as aK,
  runTableChromeCommand as aL,
  runTableCommand as aM,
  runToolbarCommand as aN,
  selectedDrawingOverlayTargetOf as aO,
  selectedImageStateOf as aP,
  surfacePaintScale as aQ,
  tableChromeIconPaths as aR,
  tableChromeLabelKeyForTarget as aS,
  tableChromeToolbarState as aT,
  tableChromeVisible as aU,
  tableCommandToolbarState as aV,
  toolbarCommandState as aW,
  toolbarCommandStates as aX,
  type TableInteractionLabelKey as aa,
  type ToolbarCommandState as ab,
  WORD_DEFAULT_FONT as ac,
  applyTableChromePick as ad,
  blankDocumentBytes as ae,
  canExecuteImageCommand as af,
  captureImageMutationPreconditions as ag,
  chromeControlCount as ah,
  chromeMenuSlots as ai,
  chromeProbeForSlot as aj,
  chromeSlotId as ak,
  commandForSlot as al,
  commandForSlotValue as am,
  commandForTableChromeSlotValue as an,
  composeFontConfiguration as ao,
  computeImageResizeResult as ap,
  computeMovedImagePosition as aq,
  computeResizedImageExtentEmu as ar,
  createDocxEditor as as,
  createFontSource as at,
  createImageOverlayScrollPort as au,
  cssPixelsToLayoutPoints as av,
  defaultChromeGroups as aw,
  defaultTableLabel as ax,
  emuToOverlayPoints as ay,
  executeImageCommand as az,
  CHROME_MENUS as b,
  CHROME_UNAVAILABLE_KEY as c,
  type ChromeControl as d,
  type ChromeControlId as e,
  type ChromeControlState as f,
  type ChromeGroup as g,
  type ChromeGroupId as h,
  type ChromeMenu as i,
  type ChromeMenuEntry as j,
  type ChromeMenuId as k,
  type ChromeMenuItemEntry as l,
  type ChromeMenuSeparatorEntry as m,
  type ChromeMenuSubmenuEntry as n,
  type ChromeSlotId as o,
  DEFAULT_TABLE_CHROME_DRAFT as p,
  type DocxEditorConfig as q,
  type FontConfigurationBase as r,
  type FontConfigurationFragment as s,
  type FontLoadFailure as t,
  type FontLoadFailureReason as u,
  type FontMeasurementState as v,
  type FontResolutionRequest as w,
  type FontResolver as x,
  type FontUrlSource as y,
  type HyperlinkChromeHandlers as z,
};
