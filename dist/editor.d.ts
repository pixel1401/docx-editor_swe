...
export {
  ...
  c as ImageCropPermille,
  S as SelectedImageState,
  d as cropPercentFromCropPermille,
  e as cropPercentFromPermille,
  f as cropPercentFromSourceCrop,
  g as cropPermilleFromCropPercent,
  h as cropPermilleFromPercent,
  s as sourceCropFromCropPercent,
  v as validateImageCropPercent,
} from "./editor-OnlXyh-5.js";
import { L as LayoutShapingOptions } from "./shaped-measurer-BT4FqYe9.js";
import {
  P as PaginatedSurfaceOptions,
  O as OpenPaginatedResult,
  a as PaginatedSurface,
  T as TableCommandPlan,
  D as DocxEditorInstance,
} from "./index-DKCWfUri.js";
export {
  A as AnchorFrameOrigin,
  C as CHROME_GROUPS,
  b as CHROME_MENUS,
  c as CHROME_UNAVAILABLE_KEY,
  d as ChromeControl,
  e as ChromeControlId,
  f as ChromeControlState,
  g as ChromeGroup,
  h as ChromeGroupId,
  i as ChromeMenu,
  ...
  o as ChromeSlotId,
  p as DEFAULT_TABLE_CHROME_DRAFT,
  q as DocxEditorConfig,
  E as EMU_PER_POINT,
  F as FinalizedImageOverlayInteraction,
  ...
  B as HyperlinkOps,
  I as IMAGE_OVERLAY_NUDGE_PT,
  G as IMAGE_OVERLAY_NUDGE_SHIFT_PT,
  J as ImageInteractionSession,
  K as ImageOverlayScrollPort,
  L as ImageResizeHandle,
  M as ImageResizeResult,
  N as LoadFontsRequest,
  Q as LoadFontsResult,
  R as MAX_RESOLVER_FAMILIES,
  S as OverlayFrameRect,
  U as PaginatedSurfaceState,
  V as RunTableChromeCommandResult,
  W as SelectedDrawingOverlayTarget,
  X as SurfaceFormatting,
  Y as SurfaceHyperlink,
  Z as SurfaceNavigation,
  _ as SurfaceOverlayCoordinates,
  $ as TABLE_BORDER_STYLE_OPTIONS,
  a0 as TABLE_BORDER_TARGET_OPTIONS,
  a1 as TABLE_BORDER_WIDTH_OPTIONS,
  a2 as TABLE_CHROME_SLOT_IDS,
  a3 as TableBorderStyleOption,
  a4 as TableBorderTargetOption,
  a5 as TableBorderTargetValue,
  a6 as TableBorderWidthOption,
  a7 as TableChromeDraft,
  a8 as TableChromePick,
  a9 as TableChromeSlotId,
  aa as TableInteractionLabelKey,
  ab as ToolbarCommandState,
  ac as WORD_DEFAULT_FONT,
  ad as applyTableChromePick,
  ae as blankDocumentBytes,
  af as canExecuteImageCommand,
  ag as captureImageMutationPreconditions,
  ah as chromeControlCount,
  ai as chromeMenuSlots,
  aj as chromeProbeForSlot,
  ak as chromeSlotId,
  al as commandForSlot,
  am as commandForSlotValue,
  an as commandForTableChromeSlotValue,
  ao as composeFontConfiguration,
  ap as computeImageResizeResult,
  aq as computeMovedImagePosition,
  ar as computeResizedImageExtentEmu,
  as as createDocxEditor,
  at as createFontSource,
  au as createImageOverlayScrollPort,
  av as cssPixelsToLayoutPoints,
  aw as defaultChromeGroups,
  ax as defaultTableLabel,
  ay as emuToOverlayPoints,
  az as executeImageCommand,
  aA as finalizeImageOverlayInteraction,
  aB as formattingBarChromeGroups,
  aC as isStaleImageInteractionCommit,
  aD as isTableChromeSlot,
  aE as layoutPointsToCssPixels,
  aF as loadFonts,
  aG as overlayFrameToSheetCssPixels,
  aH as pointsToEmu,
  aI as probeTableChromeCommand,
  aJ as resizePreservesAspect,
  aK as runSave,
  aL as runTableChromeCommand,
  aM as runTableCommand,
  aN as runToolbarCommand,
  aO as selectedDrawingOverlayTargetOf,
  aP as selectedImageStateOf,
  aQ as surfacePaintScale,
  aR as tableChromeIconPaths,
  aS as tableChromeLabelKeyForTarget,
  aT as tableChromeToolbarState,
  aU as tableChromeVisible,
  aV as tableCommandToolbarState,
  aW as toolbarCommandState,
  aX as toolbarCommandStates,
} from "./index-DKCWfUri.js";
import {
  A as AutomationCapabilities,
  a as AutomationHost,
} from "./protocol-ooK7PAXz.js";
export {
  CollectReviewItems,
  EditorModule,
...
import { f as DocumentThemeColorEntry } from "./tree-session-DUBhL9NT.js";
import { S as SemanticLayout } from "./semantic-records-B-qbrnp2.js";
export { T as TextMeasurer } from "./semantic-records-B-qbrnp2.js";
export {
  ...
  d as resolveSvgIntrinsicSize,
  s as sniffImageMime,
  v as validateRasterHeader,
} from "./image-resources-e13t-pgy.js";
export { S as SectionProperties } from "./semantic-cell-selection-Dc-_enhm.js";
export { R as ReviewModelInput } from "./review-support-Bl9sN8cv.js";
export {
...
export {
  ...
  a as RevisionAuthorAssignments,
...
declare function createLayoutShaping(
 ...
 */
declare function generateRulerTicks(
  lengthPx: number,
  unit: RulerUnit,
): RulerTick[];
/** The first page's box, which the rulers measure against. */
declare function rulerPageBox(
  pages: readonly {
 ...
 * message.
 */
declare function mountPaginatedSurface(
...
declare function tableCommandState(
 ...
 */
declare function createBrowserAutomationHost(
...
declare function resolveThemeColorHex(
  color: Extract<
    ColorValue,
    {
      kind: "theme";
 ...
 */
declare function lowerColorValueForBorder(
  color: ColorValue,
  themeColors: readonly DocumentThemeColorEntry[],
): ColorLowerResult;
/**
 ...
 */
declare function lowerColorValueForFill(
  color: ColorValue,
  themeColors: readonly DocumentThemeColorEntry[],
): ColorLowerResult;
/** Resolve any public colour to a CSS `#RRGGBB` string for chrome display. */
declare function resolveColorValueToCss(
 ...
 */
declare function surfaceExtent(
...
declare function validateDrawingPositionInput(
...
declare function positionInputFromPropertiesCommand(
  command: {
    readonly horizontalEmu?: number;
    readonly verticalEmu?: number;
    readonly relativeToH?: string;
...
declare function validateSetImagePositionCommand(
  command: {
    readonly horizontalEmu?: number;
    readonly verticalEmu?: number;
    readonly relativeToH?: string;
