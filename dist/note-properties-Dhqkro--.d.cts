import { a as OoxmlElement, e as OoxmlPart, O as OoxmlNode } from './ooxml-tree-CG0odFyi.cjs';
import { R as RevisionAddress } from './tree-op-types-DOYNkKqD.cjs';
...
export { type AuthoredNoteProperties as A, isLegalEndnotePosition as B, type CommentAnchor as C, DEFAULT_ENDNOTE_PROPERTIES as D, type EndnotePosition as E, type FootnotePosition as F, isLegalFootnotePosition as G, isLegalNumRestart as H, linkRevisionReplies as I, parseAuthoredNoteProperties as J, resolveEndnoteProperties as K, type LinkableReviewItem as L, resolveFootnoteProperties as M, type NoteNumRestart as N, reviewItemKey as O, reviewItemRanges as P, revisionItemsOf as Q, type ResolvedFootnoteProperties as R, settingsPartOf as S, threadStateOfPart as T, W15_NAMESPACE_URI as W, type ResolvedEndnoteProperties as a, type CommentPosition as b, type CommentRecord as c, type CommentThreadState as d, DEFAULT_FOOTNOTE_PROPERTIES as e, type ReviewCommentItem as f, type ReviewItem as g, type ReviewModelInput as h, type ReviewPosition as i, type ReviewRange as j, type ReviewRevisionItem as k, type ReviewRevisionKind as l, authoredDocumentEndnoteProperties as m, authoredDocumentFootnoteProperties as n, authoredEndnotePropertiesFromSectPr as o, paragraphOrderOfPart as p, authoredFootnotePropertiesFromSectPr as q, collectReviewItems as r, commentAnchorsOfStory as s, commentBodyText as t, commentInitials as u, commentItemsOf as v, commentsOfPart as w, deepParagraphOrderOfPart as x, firstReviewRange as y, hasAnyComment as z };
